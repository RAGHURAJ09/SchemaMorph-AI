  ...
  return (
    <nav style={{ position:"fixed",top:0,left:0,right:0,zIndex:100, background:scrolled?"rgba(9,12,18,0.9)":"transparent", backdropFilter:scrolled?"blur(14px)":"none", borderBottom:scrolled?"0.5px solid rgba(255,255,255,0.07)":"none", padding:"0 28px", transition:"all 0.3s ease" }}>
      <div style={{ maxWidth:1100,margin:"0 auto",display:"flex",alignItems:"center",height:62,gap:8 }}>
        ...
        <a href="/login" style={{ marginLeft:10,background:"transparent",color:"rgba(255,255,255,0.8)",border:"0.5px solid rgba(255,255,255,0.2)",padding:"7px 16px",borderRadius:8,fontSize:13,fontWeight:500,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none" }}>Log in</a>
        <a href="/register" style={{ marginLeft:6,background:"#1D9E75",color:"#fff",padding:"7px 16px",borderRadius:8,fontSize:13,fontWeight:600,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none" }}>Sign up →</a>
      </div>
    </nav>
  );
}
  ...
  return (
    <section style={{ minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"110px 24px 60px",textAlign:"center",position:"relative" }}>
      ...
      <div style={{ display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap",animation:"fadeUp 0.6s 0.35s ease both" }}>
        <a href="/register" style={{ background:"#1D9E75",color:"#fff",padding:"13px 28px",borderRadius:10,fontSize:15,fontWeight:600,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none",display:"inline-block" }}>Get started →</a>
        <a href="/login" style={{ background:"rgba(255,255,255,0.06)",color:"rgba(255,255,255,0.82)",border:"0.5px solid rgba(255,255,255,0.15)",padding:"13px 24px",borderRadius:10,fontSize:15,fontWeight:500,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none",display:"inline-block" }}>Log in</a>
      </div>
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        body{background:#090c12;overflow-x:hidden}
            ...
            <section style={{ padding:"80px 24px",textAlign:"center" }}>
              <div style={{ maxWidth:500,margin:"0 auto" }}>
                ...
                <div style={{display:"flex",gap:12,justifyContent:"center"}}>
                  <a href="/register" style={{background:"#1D9E75",color:"#fff",padding:"12px 26px",borderRadius:10,fontSize:14,fontWeight:600,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none",display:"inline-block"}}>Get started →</a>
                  <a href="/login" style={{background:"rgba(255,255,255,0.05)",color:"rgba(255,255,255,0.75)",border:"0.5px solid rgba(255,255,255,0.12)",padding:"12px 22px",borderRadius:10,fontSize:14,fontWeight:500,fontFamily:"Space Grotesk,sans-serif",textDecoration:"none",display:"inline-block"}}>Log in</a>
                </div>
              </div>
            </section>
          </>
        ...
        <footer style={{ background:"rgba(6,8,16,0.96)",borderTop:"0.5px solid rgba(255,255,255,0.06)",padding:"20px 28px" }}>
          <div style={{ maxWidth:1000,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12 }}>
            ...
            <div style={{display:"flex",gap:16}}>
              {[["Log in","/login"],["Sign up","/register"]].map(([t,h])=>(
                <a key={t} href={h} style={{fontFamily:"Space Grotesk,sans-serif",fontSize:12,color:"rgba(255,255,255,0.28)",textDecoration:"none"}}>{t}</a>
              ))}
            </div>
          </div>
        </footer>
